...
void sequentialMultiply() {
    ...
    clock_t start = clock();  // Inicio de tiempo
    ...
    clock_t end = clock();  // Fin de tiempo

    writeMatrix(C, "C_seq.txt");
    cout << "Matriz C secuencial guardada en C_seq.txt" << endl;
    cout << "Tiempo secuencial: " << double(end - start) / CLOCKS_PER_SEC << " segundos" << endl;
}

// ✅ Versión paralela (sin cambios)
